...
export interface ApiLandingLanding extends Schema.SingleType {
  ...
  attributes: {
    tech_skills: Attribute.Relation<
      'api::landing.landing',
      'oneToMany',
      'api::tech-skill.tech-skill'
    >;
    selected_projects: Attribute.Relation<
      'api::landing.landing',
      'oneToMany',
      'api::project.project'
    >;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    journey: Attribute.Blocks;
    start_at: Attribute.Date & Attribute.Required;
    finish_at: Attribute.Date & Attribute.Required;
    cover: Attribute.Media<'images'> & Attribute.Required;
    preview: Attribute.Media<'images', true> & Attribute.Required;
    label: Attribute.Enumeration<['paid', 'personal', 'free']> &
      Attribute.Required &
...
export interface ApiTechSkillTechSkill extends Schema.CollectionType {
